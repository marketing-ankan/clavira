@component('emails.layout', ['title' => 'Reset your Clavira password'])
    <p style="margin:0 0 16px; font-size:20px; font-family: Georgia, serif; color:#241f19;">Hello {{ $name }},</p>

    <p style="margin:0 0 20px;">
        We received a request to reset the password on your Clavira account.
    ...
    <p style="margin:0 0 8px; font-size:13px; color:#7d7266;">
        This secure link is valid for {{ $ttlMinutes }} minutes and can be used once.
    </p>

    <p style="margin:0 0 20px; font-size:13px; color:#7d7266;">
        If you did not ask for this, no action is needed — your password stays as it is,
        and this link will simply expire.
    </p>
