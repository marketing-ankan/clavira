...
class CatalogSeeder extends Seeder
{
    ...
    private function seedCollections(): array
    {
        $rows = [
            ...
            ['The NRI Fusion Edit', 'nri-fusion-edit', 'NRI Collection', 'Pieces that speak both languages — heritage and contemporary.', 'Lightweight, versatile, and travel-ready — jewels that transition from boardroom to ballroom. Fully insured shipping to over 50 countries.', 'p54_00.jpg'],
